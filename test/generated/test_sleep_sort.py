...
def test_sleep_sort_valid(in_params, expected, sleep_sort):
...
def test_sleep_sort_invalid(in_params, expected, sleep_sort):
    actual = sleep_sort.run(params=in_params)
    actual = actual.strip()
    assert actual == expected
