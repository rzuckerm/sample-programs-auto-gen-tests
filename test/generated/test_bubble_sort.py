...
def test_bubble_sort_valid(in_params, expected, bubble_sort):
    actual = bubble_sort.run(params=in_params)
...
def test_bubble_sort_invalid(in_params, expected, bubble_sort):
    actual = bubble_sort.run(params=in_params)
    actual = actual.strip()
    assert actual == expected
