...
def test_selection_sort_valid(in_params, expected, selection_sort):
    actual = selection_sort.run(params=in_params)
...
def test_selection_sort_invalid(in_params, expected, selection_sort):
    actual = selection_sort.run(params=in_params)
    actual = actual.strip()
    assert actual == expected
