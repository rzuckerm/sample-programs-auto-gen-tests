...
def test_insertion_sort_valid(in_params, expected, insertion_sort):
    actual = insertion_sort.run(params=in_params)
...
def test_insertion_sort_invalid(in_params, expected, insertion_sort):
    actual = insertion_sort.run(params=in_params)
    actual = actual.strip()
    assert actual == expected
