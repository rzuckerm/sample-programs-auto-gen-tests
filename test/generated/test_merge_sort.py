...
def test_merge_sort_valid(in_params, expected, merge_sort):
    actual = merge_sort.run(params=in_params)
...
def test_merge_sort_invalid(in_params, expected, merge_sort):
    actual = merge_sort.run(params=in_params)
    actual = actual.strip()
    assert actual == expected
